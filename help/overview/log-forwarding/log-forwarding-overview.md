...
2. **CDN 구성** — 이러한 세부 정보를 사용하여 CDN 공급자의 콘솔에서 로그 전달 작업을 만들거나 로그를 수동으로 업로드합니다. CloudFront의 경우 콘솔을 사용하거나 **AWS CLI**&#x200B;로만 게재 설정을 완료할 수 있습니다. [CloudFront(AWS CLI)](/help/overview/log-forwarding/cloudfront-cli.md)을(를) 참조하십시오.
