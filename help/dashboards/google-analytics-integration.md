...
1. **Analytics에 연결**&#x200B;을 선택합니다. LLM Optimizer에서 **고객 구성 > Analytics**(으)로 보냅니다. Analytics 공급자 선택기에서 **Google Analytics 4**&#x200B;을(를) 선택합니다.

   ![고객 구성, GA4가 있는 Analytics 탭 선택됨](/help/dashboards/assets/ga4-integration-02-analytics-ga4-picker.png)

1. **연결**&#x200B;을 선택합니다. Google 로그인 화면에 새 브라우저 탭이 열립니다.
