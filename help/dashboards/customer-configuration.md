...
이 탭에서 프롬프트를 검토, 관리 및 사용자 지정할 수 있습니다. [브랜드 유무 분석](/help/dashboards/brand-presence.md) .csv를 업로드할 수 있으며 이 목록은 해당 분석의 프롬프트 및 주제로 채워지거나 Adobe에서 만든 [프롬프트 라이브러리를 다운로드](/help/overview/best-practices-topics-prompts.md)합니다. 필요에 따라 주제 및 관련 프롬프트를 삭제, 수정 및 추가할 수도 있습니다.
