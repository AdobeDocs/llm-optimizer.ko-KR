...
LLM Optimizer이 다양한 시장 및 경쟁 환경에서 브랜드 존재감을 모니터링하고 분석하는 방법을 구성하려면 다음 탭에 액세스할 수 있습니다.
...
이 탭에서 프롬프트를 검토, 관리 및 사용자 지정할 수 있습니다. [브랜드 존재감 분석](/help/dashboards/brand-presence.md) .csv를 업로드할 수 있으며 이 목록은 해당 분석의 프롬프트 및 주제로 채워지거나 Adobe에서 만든 [프롬프트 라이브러리를 다운로드](/help/overview/best-practices-topics-prompts.md)합니다. 필요에 따라 주제 및 관련 프롬프트를 삭제, 수정 및 추가할 수도 있습니다.

Data Insights .csv 파일을 가져오려면 먼저 브랜드 존재감 대시보드에서 파일을 내보내야 합니다. 그 방법에 대해 알아보려면 [데이터 인사이트](/help/dashboards/brand-presence.md#data-insights) 섹션을 참조하십시오. 파일이 생성되면:
...
Adobe에서 만든 산업 프롬프트 라이브러리를 다운로드하고 사용하는 방법에 대해 알아보려면 [이 페이지](/help/overview/best-practices-topics-prompts.md)의 산업 프롬프트 라이브러리 섹션을 참조하십시오.
...
브랜드 별칭을 사용하여 다양한 카테고리와 영역에서 추적해야 하는 브랜드의 대체 이름과 변형을 구성할 수 있습니다. 이를 통해 모든 브랜드 언급을 포괄적으로 모니터링할 수 있습니다. 브랜드 별칭을 추가하려면 다음을 수행하십시오.
