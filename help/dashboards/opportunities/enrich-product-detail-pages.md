...
[Edge에서 최적화](https://experienceleague.adobe.com/en/docs/llm-optimizer/using/resources/optimize-at-edge/overview#what-is-optimize-at-edge)를 사용하여 이 기회를 최적화할 수 있습니다. 최적화는 인간 방문자에게 영향을 주지 않고 AI 에이전트에게만 제공되며(보트 전용 제공), CDN 계층에 적용되므로 CMS 또는 카탈로그 변경이 필요하지 않으며, 개발자 참여 없이도 몇 분 안에 적용할 수 있으므로 대규모 제품 카탈로그의 빠르고 위험도가 낮은 배포 경로가 됩니다.
...
아직 온보딩하지 않은 경우 **최적화 배포**&#x200B;를 클릭하면 온보딩 프로세스로 이동합니다. Edge에서 최적화 작동 방법, 지원되는 CDN 공급자 및 온보딩 프로세스에 대한 자세한 내용은 [Edge에서 최적화](https://experienceleague.adobe.com/en/docs/llm-optimizer/using/resources/optimize-at-edge/overview#what-is-optimize-at-edge) 페이지를 참조하십시오.
