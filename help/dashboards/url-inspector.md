...
* **자체 소유 인용이 있는 고유 프롬프트** - 자체 소유 인용이 있는 총 고유 AI 프롬프트 수.
...
인용된 보기와 트렌드 보기 모두에서 URL은 각 행의 끝에 **세부 정보** 단추가 있습니다. 버튼을 클릭하면 추가 세부 정보가 포함된 별도의 창이 표시됩니다. 세부 정보 창에는 URL을 인용하는 빈도, URL이 표시되는 주제 및 프롬프트 <!--the sentiment of AI responses where it is mentioned,-->, 시간 경과에 따른 에이전트 및 참조 트래픽 트렌드(소유한 URL의 경우)가 표시됩니다.
